...
/// PromptingResultCard displays the real LLM output, model name, measured latency,
/// and full dispatched prompt for a single prompting technique.
class PromptingResultCard extends StatelessWidget {
  final String title;
  final PromptingResult result;
  final Color accentColor;
  final IconData icon;

  const PromptingResultCard({
    super.key,
    required this.title,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Dispatched Prompt Section (Collapsible/Preview)
                Container(
                  width: double.infinity,
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Prompt copied', style: GoogleFonts.inter(fontSize: 12)),
