...
/// RagPromptCard displays the exact RAG prompt constructed with retrieved context.
class RagPromptCard extends StatelessWidget {
  final String prompt;
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            Text('RAG Prompt copied to clipboard', style: GoogleFonts.inter(fontSize: 12)),
          ],
        ),
